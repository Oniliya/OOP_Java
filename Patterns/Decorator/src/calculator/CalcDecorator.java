// класс декоратор имплементируем интерфейс калькулятора iCalculable
// чтобы "подменить" методы
// и должны включить в метод и калькулятор и логгер
...
public class CalcDecorator implements iCalculable {
    ...
    // --------------------------------------------
    // новый функционал для деклратора-калькулятора
    // --------------------------------------------
    @Override
